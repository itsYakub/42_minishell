...
SFILES = $(addsuffix .c, $(addprefix srcs/, minishell env_array cmd_executor cmd_splitter cmd_expander cmd_redirector cmd_checker utils cmd_parser arg_splitter lw_split))
SRCS= \
	$(BUILTINS) \
	$(SFILES)
OBJS= \
