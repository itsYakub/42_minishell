...
SFILES = $(addsuffix .c, $(addprefix srcs/, minishell env_array cmd_executor cmd_splitter cmd_expander cmd_redirector cmd_checker \
str_utils cmd_parser arg_splitter cmd_builtins cmd_piper msh_getutil env_utils signals cmd_redir_setup cmd_printer))
SRCS= \
	$(BUILTINS) \
	$(SFILES)
OBJS= \
